            ...
            <header>
                <div className="container">
                    ...
                    <ul>
                        ...
                        <li><Link to='/Alldepartment'><i className="far fa-hospital"></i>Departments</Link></li>
                        <li><Link to='/Doctorlist'><i className="fas fa-user-md"></i>Doctor's</Link></li>
                        <li><Link to='/Myhospital'><i className="far fa-hospital"></i>Myhospital</Link></li>
                        <li><Link to='/HospitalSpeciality'><i className="fas fa-user-md"></i>Specialities</Link></li>
